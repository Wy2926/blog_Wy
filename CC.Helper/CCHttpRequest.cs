...
namespace CC.Helper
{
    public class CCHttpRequest
    {
        ...
        /// <returns></returns> 
        public static async Task<HttpWebResponse> CreateGetHttpResponseAsync(string url, IDictionary<string, string> parameters = null, int? timeout = 5, string userAgent = null, CookieCollection cookies = null)
        {
