        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParArticleTypeId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArticleTypes_ArticleTypes_ParArticleTypeId",
                        column: x => x.ParArticleTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogProposals", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ioc = table.Column<string>(maxLength: 256, nullable: true),
                    Email = table.Column<string>(maxLength: 256, nullable: true),
                    OfflineTime = table.Column<DateTime>(nullable: false),
                    Order = table.Column<int>(nullable: false),
                    Ip = table.Column<string>(nullable: true),
                    ToExamine = table.Column<int>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendshipLinks", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SearchSubmitHistorys",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchSubmitHistorys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Articles_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParArticleCommentId = table.Column<long>(nullable: true),
                    ReplyNickName = table.Column<string>(nullable: true),
                    Floor = table.Column<int>(nullable: true),
                    NickName = table.Column<string>(maxLength: 30, nullable: false),
                    Email = table.Column<string>(maxLength: 200, nullable: true),
                    Body = table.Column<string>(maxLength: 1000, nullable: false),
                    Site = table.Column<string>(maxLength: 1000, nullable: true),
                    Ip = table.Column<string>(nullable: false),
                    ToExamine = table.Column<int>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleComments_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleComments_CreatorUserId",
                table: "ArticleComments",
                column: "CreatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleTypes_ParArticleTypeId",
                table: "ArticleTypes",
                column: "ParArticleTypeId");
        }
